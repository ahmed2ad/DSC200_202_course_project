...
recruitment_boys_girls <- tdata %>%
  group_by(Sex) %>%
  summarise(Total_recruit_teachers= sum(Total_Numb_Teachers))
view(recruitment_boys_girls)
```

Comments about your answer: We can see the teachers that were recruited in girls schools more than teachers recruited in boys schools.
