...
```{r tidy_data}
tdata <- tdata %>%
+ rename(Level = "المرحلة",Administrative_Region = "المنطقة الإدارية",sex = "الجنس",Education_Office = "مكتب التربية",Authority = "السلطة",Education_System = "نظام الدراسة",Education_Type = "نوع التعليم",School_Type = "نوع المدرسة",Saudi_Teacher = "معلم سعودي",Expat_Teacher = "معلم غير سعودي",Total_Teachers = "معلمين جملة",year = "السنة")
```
